...
void gen_error(int i, int ll, char *s) {
  ...
  switch (i) {
    case 11 :
      printf("illegal identifier in expression (case : 11)\n");
      break;
    case 12 :
      printf("illegal l-value expression (case : 12)\n");
      break;
    case 13 :
      printf("identifier %s not l-value expression (case : 13) \n", s);
      break;
    case 20 :
      printf("illegal default label in switch statement (case : 20) \n");
      break;
    case 21 :
      printf("illeagl case label in switch statement (case : 21) \n");
      break;
    case 22 :
      printf("no destination for continue statement (case : 22) \n");
      break;
    case 23 :
      printf("no destination for break statement (case : 23) \n");
      break;
    case 100 :
      printf("fatal compiler error during code generation (case : 100) \n");
      break;
    default :
      printf("unknown \n");
      break;
