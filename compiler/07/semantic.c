...
BOOLEAN     isPointerOrArrayType_semantic(A_TYPE *);
...
A_TYPE *sem_expression(A_NODE *node) {
    ...
    switch(node->name) {
        ...
        case N_EXP_ARRAY :
            ...
            t1 = node->llink->type;
            t2 = node->rlink->type;
            if (isPointerOrArrayType_semantic(t1))
        ...
        case N_EXP_POST_DEC :
            ...
            // usual binary conversion between the experssion and 1
...
BOOLEAN isPointerOrArrayType_semantic(A_TYPE *t) {
...
void semantic_error(int i, int ll, char *s) {
    ...
    switch (i) {
        ...
        case 93:
            ...
            break;
        case 94: 
            printf("self-referential struct declartion\n", i);
			break;
        default:
            printf("unknown\n");
            break;
